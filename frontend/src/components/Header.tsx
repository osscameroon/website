  ...
  return <header className="sticky top-0 z-50 border-b border-border-soft bg-white/90 backdrop-blur-xl">
    <div className="mx-auto flex max-w-container items-center gap-7 py-4" style={{paddingLeft:'clamp(16px,4vw,24px)',paddingRight:'clamp(16px,4vw,24px)'}}>
      ...
      <div className="ml-auto hidden items-center gap-3 lg:flex">
        <a href="https://opencollective.com/osscameroon/contribute/backer-26797/checkout?interval=month&amount=2&name=&legalName=&email=" target="_blank" rel="noopener noreferrer" className="rounded-btn border-[1.5px] border-blue px-5 py-3 text-[15px] font-semibold text-blue transition hover:-translate-y-0.5 hover:bg-blue hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-blue">Support the community</a>
    ...
    {open && <div id="mobile-menu" className="border-t border-border-soft bg-white lg:hidden">
      <nav className="mx-auto flex max-w-container flex-col gap-1 px-[clamp(16px,4vw,24px)] py-4" aria-label="Mobile">
        ...
        <div className="mt-3 flex flex-col gap-3">
          <a href="https://opencollective.com/osscameroon/contribute/backer-26797/checkout?interval=month&amount=2&name=&legalName=&email=" target="_blank" rel="noopener noreferrer" className="rounded-btn border-[1.5px] border-blue px-5 py-3 text-center text-[15px] font-semibold text-blue transition hover:bg-blue hover:text-white">Support the community</a>

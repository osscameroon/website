...
const BASE_PROJECTS_RAW = [
  { name: "MiniYotas", desc: "Make a contribution to any of OSS Cameroon GitHub project and earn some Yotas.", tags: ["Blade"], lang: "Blade", stars: 12, img: PROJ_IMGS[0], contributors: ["assets/avatars/a4.png"], ...PLACEHOLDER_EXTRA },
  { name: "AestheticDialogs", desc: "An Android Library for fluid, beautiful, custom Dialogs.", tags: ["Docs","Issues 619","★ 46k"], lang: "Kotlin", stars: 46000, img: PROJ_IMGS[1], contributors: ["assets/avatars/a1.png","assets/avatars/a3.png"], ...PLACEHOLDER_EXTRA },
  { name: "Jobsika", desc: "Company ratings and salaries in Cameroon", tags: ["Python","Issues 3"], lang: "Python", stars: 320, img: PROJ_IMGS[2], contributors: ["assets/avatars/a7.png"], ...PLACEHOLDER_EXTRA },
  { name: "Kamtar API", desc: "Logistics API connecting truck drivers and shippers across Cameroon.", tags: ["Typescript","Issues 41"], lang: "Typescript", stars: 870, img: PROJ_IMGS[1], contributors: ["assets/avatars/a5.png","assets/avatars/a6.png"], ...PLACEHOLDER_EXTRA },
  { name: "Nkwa Docs", desc: "Documentation platform for the local payments ecosystem.", tags: ["Docs","Issues 12"], lang: "Typescript", stars: 210, img: PROJ_IMGS[0], contributors: ["assets/avatars/a2.png"], ...PLACEHOLDER_EXTRA },
  { name: "MoovSMS", desc: "Send and receive SMS through local operators from a single client.", tags: ["Go","Issues 7"], lang: "Go", stars: 1400, img: PROJ_IMGS[2], contributors: ["assets/avatars/a4.png","assets/avatars/a1.png"], ...PLACEHOLDER_EXTRA },
  { name: "Ekang UI", desc: "A component library with patterns drawn from Cameroonian textiles.", tags: ["React","Issues 88"], lang: "Typescript", stars: 5600, img: PROJ_IMGS[1], contributors: ["assets/avatars/a3.png"], ...PLACEHOLDER_EXTRA },
  { name: "Solar Monitor", desc: "Track solar inverter output and battery health from the browser.", tags: ["Python","Issues 19"], lang: "Python", stars: 640, img: PROJ_IMGS[0], contributors: ["assets/avatars/a6.png","assets/avatars/a7.png"], ...PLACEHOLDER_EXTRA },
  { name: "Tontine", desc: "Open source savings-group ledger for informal community funds.", tags: ["Blade","Issues 5"], lang: "Blade", stars: 95, img: PROJ_IMGS[2], contributors: ["assets/avatars/a5.png"], ...PLACEHOLDER_EXTRA },
];
